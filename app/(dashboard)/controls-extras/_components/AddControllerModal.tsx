...
export function AddControllerModal({
  ...
  const modalTitle = "Add New Controllers";
  ...
  const createControllerMutation = useMutation({
    mutationFn: async () => {
      ...
      if (!response.ok || hasExplicitFailure) {
        throw new Error(data?.message ?? "Failed to add controller.");
      }
  ...
  const handleSubmit = () => {
    ...
    createControllerMutation.mutate();
  };
            ...
            <div className="space-y-5">
              ...
              <div className="grid grid-cols-1 gap-4 pt-2 sm:grid-cols-2">
                <Button
                  ...
                  variant="outline"
                  onClick={() => onOpenChange(false)}
                  disabled={createControllerMutation.isPending}
                ...
                >
                  {createControllerMutation.isPending ? "Saving..." : "Add"}
                </Button>
              </div>
            </div>
          </div>
