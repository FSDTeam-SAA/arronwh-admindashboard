...
const answers = [
  ...
  { question: "Current, what type of boiler do you have?", answer: "Combi" },
...
const optionRows = [
  ...
  ["Converting Standard Boiler to a Worcester Wall Mounted Combi", "$450"],
  ...
  ["Boiler Aftercare 10 years warranty (via va service & labour)", "Included"],
